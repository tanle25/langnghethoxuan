            ...
            <div class="tabs-container">
                ...
                <div class="tab-content">
                    <div id="tab-1" class="tab-pane active">
                        @include('back-end.shop.product.form-1')
                    </div>

                    <div id="tab-2" class="tab-pane">
                        @include('back-end.shop.product.form-2')
                    </div>

                    <div id="tab-3" class="tab-pane">
                        @include('back-end.shop.product.form-3')
                    </div>

                    <div id="tab-4" class="tab-pane">
                        @include('back-end.shop.product.form-4')
                    </div>

                    <div id="tab-5" class="tab-pane">
                        @include('back-end.shop.product.form-5')
                    </div>
                </div>
            </div>
        </div>
