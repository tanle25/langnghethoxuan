...
@section('title')
Thay đổi thông : Giấy tờ cơ sở kinh doanh
@endsection
...
<div class="wrapper wrapper-content">
	<div class="row animated fadeInRight">
		<div class="ibox float-e-margins">
			...
			<form id="form" class="form-horizontal" role="form" action="{{route('doc.update',['id'=>$obj->id])}}"
				enctype="multipart/form-data" method="POST">
				@method('PATCH')
				@csrf
					@include('back-end.shop.shop-doc.form')
