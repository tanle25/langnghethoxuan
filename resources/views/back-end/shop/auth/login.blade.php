                ...
                <div class="col-md-offset-2 col-md-8">
                    <div class="login register">
                        <div class="login-other">
                            <span>Bạn chưa có gian hàng? <a class="btn-register" href="{{route('shop.register')}}">Đăng ký</a> tại đây</span>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8">   
                                <div class="right-form-login">
                                    ...
                                    <form class="form-horizontal" method="POST" action="{{ route('shop.login.post') }}">
                                        @csrf
