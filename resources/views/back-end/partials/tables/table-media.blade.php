	...
	<tbody>
		...
		<tr>
			...
			<td class="text-center">
				@if ($obj->type == 1)
				<span class="label label-success">Ảnh</span></a>
				@elseif ($obj->type == 2)
				<span class="label label-danger">Video</span></a>
				@elseif ($obj->type == 3)
				<span class="label label-warning">Slide</span></a>
				@elseif ($obj->type == 4)
				<span class="label label-default">Khác</span></a>
				@endif
			</td>
